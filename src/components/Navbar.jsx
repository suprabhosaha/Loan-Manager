...
const Navbar = () => {
    return (
        <div className="fixed z-50 w-[100%] top-0 left-0 shadow-md bg-gradient-to-r from-white to-[#eaeae9] shadow-gray-400 py-3 px-4 flex items-center justify-between text-2xl">
            <div className="w-30">
